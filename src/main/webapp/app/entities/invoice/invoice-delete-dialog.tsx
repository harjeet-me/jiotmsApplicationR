  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="jiotmsApplicationRApp.invoice.delete.question">
          <Translate contentKey="jiotmsApplicationRApp.invoice.delete.question" interpolate={{ id: invoiceEntity.id }}>
