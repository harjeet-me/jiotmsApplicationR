    ...
    return (
      <div>
        <h2 id="country-heading">
          <Translate contentKey="jiotmsApplicationRApp.country.home.title">Countries</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="jiotmsApplicationRApp.country.home.createLabel">Create a new Country</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('jiotmsApplicationRApp.country.home.search')}
                  />
        ...
        <div className="table-responsive">
          {countryList && countryList.length > 0 ? (
            <Table responsive aria-describedby="country-heading">
              <thead>
                <tr>
                  ...
                  <th>
                    <Translate contentKey="jiotmsApplicationRApp.country.countryName">Country Name</Translate>
                  </th>
                  <th>
                    <Translate contentKey="jiotmsApplicationRApp.country.region">Region</Translate>
                  </th>
                  <th />
                </tr>
              </thead>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="jiotmsApplicationRApp.country.home.notFound">No Countries found</Translate>
            </div>
          )}
        </div>
      </div>
