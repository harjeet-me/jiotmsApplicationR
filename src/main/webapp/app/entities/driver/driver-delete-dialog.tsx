  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="jiotmsApplicationRApp.driver.delete.question">
          <Translate contentKey="jiotmsApplicationRApp.driver.delete.question" interpolate={{ id: driverEntity.id }}>
