  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="jiotmsApplicationRApp.location.delete.question">
          <Translate contentKey="jiotmsApplicationRApp.location.delete.question" interpolate={{ id: locationEntity.id }}>
