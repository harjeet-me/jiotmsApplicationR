  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="jiotmsApplicationRApp.contact.delete.question">
          <Translate contentKey="jiotmsApplicationRApp.contact.delete.question" interpolate={{ id: contactEntity.id }}>
