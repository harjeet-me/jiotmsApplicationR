...
import { getSearchEntities, getEntities } from './equipment.reducer';
    ...
    return (
      <div>
        <h2 id="equipment-heading">
          <Translate contentKey="jiotmsApplicationRApp.equipment.home.title">Equipment</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="jiotmsApplicationRApp.equipment.home.createLabel">Create a new Equipment</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('jiotmsApplicationRApp.equipment.home.search')}
                  />
        ...
        <div className="table-responsive">
          {equipmentList && equipmentList.length > 0 ? (
              ...
              <tbody>
                {equipmentList.map((equipment, i) => (
                  <tr key={`entity-${i}`}>
                    ...
                    <td>
                      <Translate contentKey={`jiotmsApplicationRApp.EquipmentEnum.${equipment.type}`} />
                    </td>
                    <td>
                      <Translate contentKey={`jiotmsApplicationRApp.SizeEnum.${equipment.size}`} />
                    </td>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="jiotmsApplicationRApp.equipment.home.notFound">No Equipment found</Translate>
            </div>
          )}
        </div>
      </div>
