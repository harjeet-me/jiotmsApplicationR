  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="jiotmsApplicationRApp.equipment.delete.question">
          <Translate contentKey="jiotmsApplicationRApp.equipment.delete.question" interpolate={{ id: equipmentEntity.id }}>
