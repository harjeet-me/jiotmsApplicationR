...
export class Task extends React.Component<ITaskProps, ITaskState> {
  ...
  render() {
    ...
    return (
      <div>
        <h2 id="task-heading">
          <Translate contentKey="jiotmsApplicationRApp.task.home.title">Tasks</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="jiotmsApplicationRApp.task.home.createLabel">Create a new Task</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('jiotmsApplicationRApp.task.home.search')}
                  />
        ...
        <div className="table-responsive">
          {taskList && taskList.length > 0 ? (
            <Table responsive aria-describedby="task-heading">
              <thead>
                <tr>
                  ...
                  <th>
                    <Translate contentKey="jiotmsApplicationRApp.task.title">Title</Translate>
                  </th>
                  <th>
                    <Translate contentKey="jiotmsApplicationRApp.task.description">Description</Translate>
                  </th>
                  <th />
                </tr>
              </thead>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="jiotmsApplicationRApp.task.home.notFound">No Tasks found</Translate>
            </div>
          )}
        </div>
      </div>
