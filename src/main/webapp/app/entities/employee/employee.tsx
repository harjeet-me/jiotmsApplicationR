    ...
    return (
      <div>
        <h2 id="employee-heading">
          <Translate contentKey="jiotmsApplicationRApp.employee.home.title">Employees</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="jiotmsApplicationRApp.employee.home.createLabel">Create a new Employee</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('jiotmsApplicationRApp.employee.home.search')}
                  />
          ...
          >
            {employeeList && employeeList.length > 0 ? (
                ...
                <thead>
                  <tr>
                    ...
                    <th className="hand" onClick={this.sort('firstName')}>
                      <Translate contentKey="jiotmsApplicationRApp.employee.firstName">First Name</Translate>{' '}
                      <FontAwesomeIcon icon="sort" />
                    </th>
                    <th className="hand" onClick={this.sort('lastName')}>
                      <Translate contentKey="jiotmsApplicationRApp.employee.lastName">Last Name</Translate> <FontAwesomeIcon icon="sort" />
                    </th>
                    <th className="hand" onClick={this.sort('email')}>
                      <Translate contentKey="jiotmsApplicationRApp.employee.email">Email</Translate> <FontAwesomeIcon icon="sort" />
                    </th>
                    <th className="hand" onClick={this.sort('phoneNumber')}>
                      <Translate contentKey="jiotmsApplicationRApp.employee.phoneNumber">Phone Number</Translate>{' '}
                      <FontAwesomeIcon icon="sort" />
                    </th>
                    <th className="hand" onClick={this.sort('hireDate')}>
                      <Translate contentKey="jiotmsApplicationRApp.employee.hireDate">Hire Date</Translate> <FontAwesomeIcon icon="sort" />
                    </th>
                    <th className="hand" onClick={this.sort('salary')}>
                      <Translate contentKey="jiotmsApplicationRApp.employee.salary">Salary</Translate> <FontAwesomeIcon icon="sort" />
                    </th>
                    <th className="hand" onClick={this.sort('commissionPct')}>
                      <Translate contentKey="jiotmsApplicationRApp.employee.commissionPct">Commission Pct</Translate>{' '}
                      <FontAwesomeIcon icon="sort" />
                    </th>
                    <th>
                      <Translate contentKey="jiotmsApplicationRApp.employee.department">Department</Translate>{' '}
                      <FontAwesomeIcon icon="sort" />
                    </th>
                    <th>
                      <Translate contentKey="jiotmsApplicationRApp.employee.manager">Manager</Translate> <FontAwesomeIcon icon="sort" />
                    </th>
                    <th />
                  </tr>
                </thead>
              ...
              <div className="alert alert-warning">
                <Translate contentKey="jiotmsApplicationRApp.employee.home.notFound">No Employees found</Translate>
              </div>
            )}
          </InfiniteScroll>
        </div>
