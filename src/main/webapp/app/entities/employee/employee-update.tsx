    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="jiotmsApplicationRApp.employee.home.createOrEditLabel">
              <Translate contentKey="jiotmsApplicationRApp.employee.home.createOrEditLabel">Create or edit a Employee</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : employeeEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  ...
                  <UncontrolledTooltip target="firstNameLabel">
                    <Translate contentKey="jiotmsApplicationRApp.employee.help.firstName" />
                  </UncontrolledTooltip>
                </AvGroup>
                <AvGroup>
                  <Label id="lastNameLabel" for="employee-lastName">
                    <Translate contentKey="jiotmsApplicationRApp.employee.lastName">Last Name</Translate>
                  </Label>
                  <AvField id="employee-lastName" type="text" name="lastName" />
                </AvGroup>
                <AvGroup>
                  <Label id="emailLabel" for="employee-email">
                    <Translate contentKey="jiotmsApplicationRApp.employee.email">Email</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label id="hireDateLabel" for="employee-hireDate">
                    <Translate contentKey="jiotmsApplicationRApp.employee.hireDate">Hire Date</Translate>
                  </Label>
                  <AvInput
                ...
                <AvGroup>
                  <Label id="salaryLabel" for="employee-salary">
                    <Translate contentKey="jiotmsApplicationRApp.employee.salary">Salary</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label for="employee-manager">
                    <Translate contentKey="jiotmsApplicationRApp.employee.manager">Manager</Translate>
                  </Label>
