    ...
    return (
      <div>
        <h2 id="job-history-heading">
          <Translate contentKey="jiotmsApplicationRApp.jobHistory.home.title">Job Histories</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="jiotmsApplicationRApp.jobHistory.home.createLabel">Create a new Job History</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('jiotmsApplicationRApp.jobHistory.home.search')}
                  />
          ...
          >
            {jobHistoryList && jobHistoryList.length > 0 ? (
                ...
                <thead>
                  <tr>
                    ...
                    <th className="hand" onClick={this.sort('startDate')}>
                      <Translate contentKey="jiotmsApplicationRApp.jobHistory.startDate">Start Date</Translate>{' '}
                      <FontAwesomeIcon icon="sort" />
                    </th>
                    <th className="hand" onClick={this.sort('endDate')}>
                      <Translate contentKey="jiotmsApplicationRApp.jobHistory.endDate">End Date</Translate> <FontAwesomeIcon icon="sort" />
                    </th>
                    <th className="hand" onClick={this.sort('language')}>
                      <Translate contentKey="jiotmsApplicationRApp.jobHistory.language">Language</Translate> <FontAwesomeIcon icon="sort" />
                    </th>
                    <th>
                      <Translate contentKey="jiotmsApplicationRApp.jobHistory.job">Job</Translate> <FontAwesomeIcon icon="sort" />
                    </th>
                    <th>
                      <Translate contentKey="jiotmsApplicationRApp.jobHistory.department">Department</Translate>{' '}
                      <FontAwesomeIcon icon="sort" />
                    </th>
                    <th>
                      <Translate contentKey="jiotmsApplicationRApp.jobHistory.employee">Employee</Translate> <FontAwesomeIcon icon="sort" />
                    </th>
                    <th />
                  </tr>
                </thead>
                <tbody>
                  {jobHistoryList.map((jobHistory, i) => (
                    <tr key={`entity-${i}`}>
                      ...
                      <td>
                        <Translate contentKey={`jiotmsApplicationRApp.Language.${jobHistory.language}`} />
                      </td>
              ...
              <div className="alert alert-warning">
                <Translate contentKey="jiotmsApplicationRApp.jobHistory.home.notFound">No Job Histories found</Translate>
              </div>
            )}
          </InfiniteScroll>
        </div>
