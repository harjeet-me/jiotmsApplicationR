    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="jiotmsApplicationRApp.jobHistory.home.createOrEditLabel">
              <Translate contentKey="jiotmsApplicationRApp.jobHistory.home.createOrEditLabel">Create or edit a JobHistory</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : jobHistoryEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="endDateLabel" for="job-history-endDate">
                    <Translate contentKey="jiotmsApplicationRApp.jobHistory.endDate">End Date</Translate>
                  </Label>
                  <AvInput
                ...
                <AvGroup>
                  <Label id="languageLabel" for="job-history-language">
                    <Translate contentKey="jiotmsApplicationRApp.jobHistory.language">Language</Translate>
                  </Label>
                  <AvInput
                  ...
                  >
                    <option value="FRENCH">{translate('jiotmsApplicationRApp.Language.FRENCH')}</option>
                    <option value="ENGLISH">{translate('jiotmsApplicationRApp.Language.ENGLISH')}</option>
                    <option value="SPANISH">{translate('jiotmsApplicationRApp.Language.SPANISH')}</option>
                  </AvInput>
                </AvGroup>
                <AvGroup>
                  <Label for="job-history-job">
                    <Translate contentKey="jiotmsApplicationRApp.jobHistory.job">Job</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label for="job-history-employee">
                    <Translate contentKey="jiotmsApplicationRApp.jobHistory.employee">Employee</Translate>
                  </Label>
