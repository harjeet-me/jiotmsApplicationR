    ...
    return (
      <div>
        <h2 id="department-heading">
          <Translate contentKey="jiotmsApplicationRApp.department.home.title">Departments</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="jiotmsApplicationRApp.department.home.createLabel">Create a new Department</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('jiotmsApplicationRApp.department.home.search')}
                  />
        ...
        <div className="table-responsive">
          {departmentList && departmentList.length > 0 ? (
            <Table responsive aria-describedby="department-heading">
              <thead>
                <tr>
                  ...
                  <th>
                    <Translate contentKey="jiotmsApplicationRApp.department.departmentName">Department Name</Translate>
                  </th>
                  <th>
                    <Translate contentKey="jiotmsApplicationRApp.department.location">Location</Translate>
                  </th>
                  <th />
                </tr>
              </thead>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="jiotmsApplicationRApp.department.home.notFound">No Departments found</Translate>
            </div>
          )}
        </div>
      </div>
