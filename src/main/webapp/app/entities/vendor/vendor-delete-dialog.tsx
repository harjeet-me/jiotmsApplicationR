  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="jiotmsApplicationRApp.vendor.delete.question">
          <Translate contentKey="jiotmsApplicationRApp.vendor.delete.question" interpolate={{ id: vendorEntity.id }}>
