  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="jiotmsApplicationRApp.region.delete.question">
          <Translate contentKey="jiotmsApplicationRApp.region.delete.question" interpolate={{ id: regionEntity.id }}>
