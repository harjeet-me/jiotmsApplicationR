    ...
    return (
      <div>
        <h2 id="region-heading">
          <Translate contentKey="jiotmsApplicationRApp.region.home.title">Regions</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="jiotmsApplicationRApp.region.home.createLabel">Create a new Region</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('jiotmsApplicationRApp.region.home.search')}
                  />
        ...
        <div className="table-responsive">
          {regionList && regionList.length > 0 ? (
            <Table responsive aria-describedby="region-heading">
              <thead>
                <tr>
                  ...
                  <th>
                    <Translate contentKey="jiotmsApplicationRApp.region.regionName">Region Name</Translate>
                  </th>
                  <th />
                </tr>
              </thead>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="jiotmsApplicationRApp.region.home.notFound">No Regions found</Translate>
            </div>
          )}
        </div>
      </div>
