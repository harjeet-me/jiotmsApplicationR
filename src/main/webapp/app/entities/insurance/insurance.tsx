    ...
    return (
      <div>
        <h2 id="insurance-heading">
          <Translate contentKey="jiotmsApplicationRApp.insurance.home.title">Insurances</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="jiotmsApplicationRApp.insurance.home.createLabel">Create a new Insurance</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('jiotmsApplicationRApp.insurance.home.search')}
                  />
        ...
        <div className="table-responsive">
          {insuranceList && insuranceList.length > 0 ? (
            <Table responsive aria-describedby="insurance-heading">
              <thead>
                <tr>
                  <th>
              ...
              <tbody>
                {insuranceList.map((insurance, i) => (
                  <tr key={`entity-${i}`}>
                    ...
                    <td>
                      <TextFormat type="date" value={insurance.expiryDate} format={APP_LOCAL_DATE_FORMAT} />
                    </td>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="jiotmsApplicationRApp.insurance.home.notFound">No Insurances found</Translate>
            </div>
          )}
        </div>
      </div>
