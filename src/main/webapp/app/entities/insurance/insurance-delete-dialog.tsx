  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="jiotmsApplicationRApp.insurance.delete.question">
          <Translate contentKey="jiotmsApplicationRApp.insurance.delete.question" interpolate={{ id: insuranceEntity.id }}>
