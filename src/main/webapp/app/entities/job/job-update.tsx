    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="jiotmsApplicationRApp.job.home.createOrEditLabel">
              <Translate contentKey="jiotmsApplicationRApp.job.home.createOrEditLabel">Create or edit a Job</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : jobEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="jobTitleLabel" for="job-jobTitle">
                    <Translate contentKey="jiotmsApplicationRApp.job.jobTitle">Job Title</Translate>
                  </Label>
                  <AvField id="job-jobTitle" type="text" name="jobTitle" />
                </AvGroup>
                <AvGroup>
                  <Label id="minSalaryLabel" for="job-minSalary">
                    <Translate contentKey="jiotmsApplicationRApp.job.minSalary">Min Salary</Translate>
                  </Label>
                  <AvField id="job-minSalary" type="string" className="form-control" name="minSalary" />
                </AvGroup>
                <AvGroup>
                  <Label id="maxSalaryLabel" for="job-maxSalary">
                    <Translate contentKey="jiotmsApplicationRApp.job.maxSalary">Max Salary</Translate>
                  </Label>
                  <AvField id="job-maxSalary" type="string" className="form-control" name="maxSalary" />
                </AvGroup>
                <AvGroup>
                  <Label for="job-employee">
                    <Translate contentKey="jiotmsApplicationRApp.job.employee">Employee</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label for="job-task">
                    <Translate contentKey="jiotmsApplicationRApp.job.task">Task</Translate>
                  </Label>
                  <AvInput
                    id="job-task"
                    type="select"
