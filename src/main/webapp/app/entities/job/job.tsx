...
export class Job extends React.Component<IJobProps, IJobState> {
  ...
  render() {
    ...
    return (
      <div>
        <h2 id="job-heading">
          <Translate contentKey="jiotmsApplicationRApp.job.home.title">Jobs</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="jiotmsApplicationRApp.job.home.createLabel">Create a new Job</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('jiotmsApplicationRApp.job.home.search')}
                  />
        ...
        <div className="table-responsive">
          {jobList && jobList.length > 0 ? (
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('jobTitle')}>
                    <Translate contentKey="jiotmsApplicationRApp.job.jobTitle">Job Title</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('minSalary')}>
                    <Translate contentKey="jiotmsApplicationRApp.job.minSalary">Min Salary</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('maxSalary')}>
                    <Translate contentKey="jiotmsApplicationRApp.job.maxSalary">Max Salary</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
                    <Translate contentKey="jiotmsApplicationRApp.job.employee">Employee</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="jiotmsApplicationRApp.job.home.notFound">No Jobs found</Translate>
            </div>
          )}
        </div>
